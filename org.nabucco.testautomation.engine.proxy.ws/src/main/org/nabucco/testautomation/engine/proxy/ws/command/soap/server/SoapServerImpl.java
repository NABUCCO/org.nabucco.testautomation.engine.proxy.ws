...
public class SoapServerImpl implements SoapServer {
	...
	/**
	 * Constructs a new instance providing a SOAP-WebService received by the
	 * given HttpServer.
	 */
    ...
    public ActionResponse execute(TestContext context, PropertyList propertyList,
        ...
        try {
            ...
            case RECEIVE: {
            	ReceiveSoapCommand serverCommand = new ReceiveSoapCommand(this.httpServer);
            ...
            case RESPOND: {
            	RespondSoapCommand serverCommand = new RespondSoapCommand(this.lastRequest);
            	returnProperties = serverCommand.execute(metadata, propertyList);
                command = serverCommand;
