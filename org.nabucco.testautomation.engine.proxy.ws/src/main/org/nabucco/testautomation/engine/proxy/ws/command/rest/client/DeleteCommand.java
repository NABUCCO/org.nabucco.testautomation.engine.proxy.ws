 ...
 */
public class DeleteCommand extends AbstractRestCommand implements WebServiceListener {
     ...
     *            the client to use
     */
    public DeleteCommand(WebServiceClient client, String defaultNSPrefix) {
    ...
    public PropertyList execute(Metadata metadata, PropertyList propertyList) throws WebServiceException {
        ...
        try {
            ...
            this.client.sendMessage(url, COMMAND, (String) null);
